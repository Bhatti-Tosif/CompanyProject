...
extension InviteWizardTablecell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = iconeCollectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.medialogocell, for: indexPath) as? InviteWizardCollectionCellCollectionViewCell else {
