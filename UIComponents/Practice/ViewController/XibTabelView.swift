...
extension XibTabelView {
    ...
    //MARK: InitialSetUp
    func initialSetUp() {
        let nib = UINib(nibName: R.nib.xibThroughTabelCell.name, bundle: nil)
        xibTableView.register(nib, forCellReuseIdentifier: R.reuseIdentifier.xibCell.identifier)
...
extension XibTabelView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let xibCell = xibTableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.xibCell.identifier) as? XibThroughTabelCell else {
