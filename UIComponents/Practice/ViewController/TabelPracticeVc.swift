...
extension TabelPracticeVc: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let practiceCell = tableView.dequeueReusableCell(withIdentifier: "tabelCell") as? TabelCellPractice else {
...
extension TabelPracticeVc: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let collectionCell = collectionOutlet.dequeueReusableCell(withReuseIdentifier: "collectionCell", for: indexPath) as? CollectionCellPractice else {
